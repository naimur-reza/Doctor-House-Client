...
import dot from "../../assets/images/Home/Vector/dot.png";
const Banner = () => {
  return (
    <>
      <div className=" bg-[#07332F] relative">
        <div className="lg:flex items-center  my-container min-h-[calc(100vh-58px)] ">
          <div className="space-y-5">
            ...
            <p className="tracking-wide  text-gray-200">
              ...
              Suscipit, a. Lorem ipsum dolor sit amet, consectetur adipisicing
              elit. Vero, quasi?
            </p>
        ...
        <img className="absolute bottom-12 left-1/3" src={cap1} alt="" />
        ...
        <img className="absolute bottom-28  left-[46%]" src={dot} alt="" />
      </div>
    </>
  );
};
